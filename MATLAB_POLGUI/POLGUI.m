...
try
    ...
    if ~isdeployed
        ...
        [filename,pathname] = ... 
            uigetfile({fullfile(ctfroot,'*.txt;*.dat;*.csv'), ...
            'Text Files (*.txt) (*.dat) (*.csv)'} ...
            ,['Select Location List File - Each Measurement Point' ...
              ' should be on a New Line']);
    end
...
if ~isdeployed
    ...
    [fileName,pathName,filterIndex] = ... 
        uiputfile({fullfile(ctfroot,'*.csv;*.dat;*.txt'), ... 
        'Comma-delimited text files (*.csv) (*.dat) (*.txt)'; ...
        ...
        fullfile(ctfroot,'*.mat'), ...
        'MAT-file (*.mat)'; ...
        ...
        fullfile(ctfroot,'*.xls;*.xlsb;*.xlsm;*.xlsx'), ...
        'Excel® spreadsheet files (*.xls) (*.xlsb) (*.xlsm) (*.xlsx)'; ...
        },'Save As...');
end
...
if ~isdeployed
    ...
    [fileName,pathName,filterIndex] = ... 
        uiputfile({fullfile(ctfroot,'*.txt;*.dat;*.csv'), ...
        'Text Files (*.txt) (*.dat) (*.csv)'} ...
        ,'Save Location List File ...');
end
